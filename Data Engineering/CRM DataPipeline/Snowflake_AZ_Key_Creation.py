...
import snowflakeSecrets, AzureConfigDetails, SAS_71624
...
secrets = {
    ...
    'sas-connection-string': SAS_71624.connectionString,
    'sas-token': SAS_71624.sasToken,
    'blob-service-url': SAS_71624.blobServiceURL
}
